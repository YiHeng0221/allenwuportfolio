...
export default function Contact() {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center px-10">
      <h1 className="mb-6 text-6xl font-bold">CONTACT ME</h1>
          ...
          <div className="flex flex-col gap-4">
            {contactInfo.map((info, index) => (
              <a
                ...
                className="flex cursor-pointer items-center gap-4 border-l-4 border-gray-300 py-2 pl-4 transition-all hover:border-white hover:bg-white/5"
